...
export default function KDAsection({ puuid, matchData }) {
    ...
    return (
        <div className='centeredColumn' style={{ gap: "10px" }}>
            ...
            <div className='splitColumn'>
                <div>
                    ...
                    <h3>Due to this, you spent&nbsp;
                    {Math.round(timeSpentDead / 60) < 300 ?
                        <span className='emphasize'>{Math.round(timeSpentDead / 60)} minutes</span> 
                        :
                        <span className='emphasize'>{Math.round(timeSpentDead / 360) / 10} hours</span>
                    }

                    <br/> dead and waiting to respawn.</h3>
