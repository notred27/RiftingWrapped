    ...
    return (
        <div style={{display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-evenly"}}>
            <div>
                ...
                {numMinutes <= 60 ?
                <h4 style={{marginTop:"5px", fontSize:"small", fontWeight:"200"}}>(You played as {topChamp} for <span style={{fontWeight:"bold"}}>{numMinutes}</span> minutes!)</h4>
                :
                <h4 style={{marginTop:"5px", fontSize:"small", fontWeight:"200"}}>(You played as {topChamp} for roughly <span style={{fontWeight:"bold"}}>{Math.round(numMinutes / 60)}</span> hours!)</h4>
